...
<html lang="en">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="colFormLabel" placeholder="Numéro bâtiment">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="date" class="form-control" id="colFormLabel" placeholder="Numéro bâtiment">
    </div>
  </div>
